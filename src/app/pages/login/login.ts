...
import { IonContent, IonButton, IonNote } from '@ionic/angular/standalone';

@Component({
  selector: 'app-login',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, GetInputText, RouterLink, IonContent, IonButton, IonNote],
